(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function i(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(n){if(n.ep)return;n.ep=!0;const a=i(n);fetch(n.href,a)}})();const g=[{id:"speak-up",icon:"🗣️",title:"Speak Up Policy",desc:"Guidelines for safely raising concerns without fear of retaliation or reprisal.",fullContent:`
    ...
    `}],m=[{id:"mh-awareness",banner:"🧠",title:"Mental Health Awareness",tag:"Essential",duration:"15 mins",progress:80,content:"Recognizing early signs of mental fatigue, anxiety, and learning how to prioritize self-care and support peers."},{id:"psych-safety",banner:"🛡️",title:"Psychological Safety in Teams",tag:"Leadership",duration:"20 mins",progress:45,content:"How to create an environment where team members feel safe to take risks, ask questions, and share honest feedback."},{id:"inclusive-workplace",banner:"🌐",title:"Inclusive Workplace Practices",tag:"Culture",duration:"12 mins",progress:100,content:"Understanding microaggressions, unconscious bias, and practical strategies to foster an inclusive workplace."},{id:"manager-toolkit",banner:"🛠️",title:"Manager Support Toolkit",tag:"Management",duration:"25 mins",progress:15,content:"Empathetic communication techniques, conflict resolution frameworks, and crisis response steps for leaders."},{id:"stress-mgmt",banner:"🌿",title:"Stress & Burnout Management",tag:"Well-being",duration:"10 mins",progress:60,content:"Workload management techniques, mindfulness practices, and boundary-setting strategies to prevent burnout."},{id:"emotional-intel",banner:"💡",title:"Emotional Intelligence at Work",tag:"Personal Dev",duration:"18 mins",progress:30,content:"Developing self-awareness, empathy, and constructive emotional regulation in high-pressure environments."}],y=[{id:"Bullying / Harassment",icon:"🚫",desc:"Repeated inappropriate behavior, power imbalance, or hostile environment."},{id:"Discrimination",icon:"⚖️",desc:"Unfair treatment based on protected characteristics (gender, race, age, etc.)."},{id:"Retaliation",icon:"⚡",desc:"Adverse actions taken following a previous report or protected activity."},{id:"Workplace Behaviour",icon:"🗣️",desc:"Unprofessional conduct, microaggressions, or inappropriate comments."},{id:"Manager / Leadership Concern",icon:"👔",desc:"Abuse of authority, unfair evaluation, or lack of support."},{id:"Conflict / Interpersonal Issue",icon:"👥",desc:"Disagreements or strained working relationships between team members."},{id:"Ethics / Conduct",icon:"📜",desc:"Breaches of professional integrity, theft, or policy violations."},{id:"Policy Violation",icon:"📋",desc:"Failure to adhere to company compliance or safety standards."},{id:"Financial / Fraud Concern",icon:"💰",desc:"Accounting irregularities, misappropriation, or embezzlement."},{id:"Conflict of Interest",icon:"🔄",desc:"Personal interests interfering with professional duties."},{id:"Well-being / Mental Health",icon:"💚",desc:"Stress, burnout, anxiety, or need for personal wellbeing support."},{id:"Other",icon:"❓",desc:"Any other workplace concern not listed above."}],b={"Bullying / Harassment":["What specific words, actions, or behavior occurred?","Where did the incident(s) take place (in office, virtual meeting, email)?","Who was present as direct witnesses or bystanders?","How frequently has this occurred (daily, weekly, isolated)?","Was this behavior previously reported to any supervisor or HR?","Did you directly communicate your discomfort to the individual?","How did the other person react when confronted or addressed?","Are there written records, messages, or emails documenting this?","Has this behavior impacted your ability to perform daily tasks?","What specific outcome, resolution, or interim support are you seeking?"],Discrimination:["What protected characteristic (race, gender, age, disability, etc.) is involved?","What specific action or decision was taken (promotion denial, task allocation)?","Are you aware of others in similar situations receiving different treatment?","When was this discriminatory pattern or decision first noticed?","Who made or influenced the decision in question?","Were any explicit or implicit bias statements made?","Do you have documentation, emails, or performance records supporting this?","Did you discuss this treatment with a manager or colleague?","How has this affected your career trajectory or work environment?","What remediation or corrective action do you hope to see?"],Retaliation:["What original complaint, report, or protected activity did you engage in?","When did you engage in that original activity?","What retaliatory action was subsequently taken against you?","What was the timing between your report and the retaliatory action?","Who initiated or carried out the adverse action?","Were any reasons or explanations provided for the action?","How has this retaliatory behavior affected your job duties or status?","Do you have evidence linking the report to the adverse action?","Are there witnesses aware of the sequence of events?","What protective steps or remedies would help resolve this?"],"Well-being / Mental Health":["How would you describe your current emotional state and wellbeing?","Is workplace workload, environment, or relationships contributing to this?","How is this impacting your physical, mental, or sleep health?","Are you experiencing signs of severe burnout or anxiety?","Have you spoken to a manager or medical professional regarding this?","Would you like immediate confidential contact from a Mental Health First Aider?","Are you interested in scheduling confidential counselling through EAP?","Do you feel safe continuing your current work duties today?","What temporary work adjustments (schedule, workload) would support you?","Would you also like to submit a formal workplace report if applicable?"],"Ethics / Conduct":["Which company policy or ethical code was violated?","What specific fraudulent, unethical, or illegal activity took place?","Who are the individuals or departments involved?","What is the estimated financial or organizational impact?","How long has this ethical breach been taking place?","Do you have financial records, receipts, or logs as evidence?","Are upper management or external parties aware of this?","Is there an immediate compliance or security risk to the company?","Did anyone direct or pressure you to participate in this activity?","What outcome or investigative action do you recommend?"]},f=[{id:"LS360-2026-001245",category:"Bullying / Harassment",risk:"High",age:"3 days",status:"Under Investigation",owner:"Investigator A (Ethics Team)",anonymous:!0,date:"2026-07-19",impact:"Emotional well-being and work performance",narrative:"Manager repeatedly making derogatory remarks during team syncs.",aiSummary:"The employee reports repeated inappropriate comments from their manager occurring over recent weeks. The employee indicates that the behaviour has affected their emotional well-being and work performance. Witness information provided. Confidential anonymous status requested.",timeline:[{date:"2026-07-19 09:15",title:"Report Submitted",desc:"Submitted via AI Chatbot with Anonymous flag."},{date:"2026-07-19 11:30",title:"AI Risk Engine Classification",desc:"Automated preliminary risk set to High due to power imbalance & frequency."},{date:"2026-07-20 08:45",title:"Case Assigned",desc:"Assigned to Senior Investigator A for formal review."},{date:"2026-07-21 14:00",title:"Witness Outreach",desc:"Initial confidential interview scheduled with nominated witness."}]},{id:"LS360-2026-001246",category:"Ethics / Conduct",risk:"Moderate",age:"5 days",status:"Under Initial Review",owner:"Investigator B (Compliance)",anonymous:!1,date:"2026-07-17",impact:"Policy Violation",narrative:"Unapproved expense claims logged for non-business events.",aiSummary:"Discrepancy identified in department travel expenditures during Q2 audit.",timeline:[{date:"2026-07-17 14:20",title:"Report Submitted",desc:"Submitted by Finance Associate."}]},{id:"LS360-2026-001247",category:"Well-being / Mental Health",risk:"Low",age:"1 day",status:"Assigned",owner:"MHFA Team Lead",anonymous:!1,date:"2026-07-21",impact:"Workplace anxiety & burnout",narrative:"Employee requested guidance for managing high project stress.",aiSummary:"Employee engaged with wellbeing support pathway for workload management.",timeline:[{date:"2026-07-21 16:30",title:"MHFA Outreach Initiated",desc:"Confidential appointment booked."}]},{id:"LS360-2026-001248",category:"Retaliation",risk:"Critical",age:"2 days",status:"Under Investigation",owner:"Legal & ER Director",anonymous:!0,date:"2026-07-20",impact:"Immediate Career & Safety Impact",narrative:"Employee removed from projects after filing safety complaint.",aiSummary:"Critical risk case involving potential retaliation following safety disclosure.",timeline:[{date:"2026-07-20 10:00",title:"Urgent Escalation Triggered",desc:"Escalated immediately to Legal Director."}]},{id:"LS360-2026-001249",category:"Workplace Behaviour",risk:"Low",age:"8 days",status:"Resolved",owner:"HR Business Partner",anonymous:!1,date:"2026-07-14",impact:"Team relationships",narrative:"Communication friction between remote team members.",aiSummary:"Interpersonal communication conflict resolved via facilitated mediation.",timeline:[{date:"2026-07-14 11:00",title:"Submitted",desc:"Mediated conversation completed."},{date:"2026-07-18 15:00",title:"Case Resolved",desc:"Agreement signed by both parties."}]}];window.POLICIES_DATA=g;window.LEARNING_MODULES=m;window.CATEGORIES_LIST=y;window.CATEGORY_QUESTIONS=b;window.INITIAL_SAMPLE_CASES=f;const v={mode:"standard",subPath:"support",step:0,isVoiceRecording:!1,biasRiskScore:0,mentalHealthRiskScore:0,chatData:{category:"",description:"",context:"",experiencing:"",dailyImpact:"",triggers:"",workloadContributing:"",adequateSupport:"",previousSteps:"",desiredSupport:"",orgContact:"",isSafe:!0,anonymous:!0,attachments:[]},empatheticStatements:["Thank you for trusting me with this.","I understand your concern and appreciate your courage.","I'm here to listen and support you completely.","I'm truly sorry you've experienced this situation.","You're not alone in this—your mental health and safety are our highest priority.","Your wellbeing is important, and every concern deserves to be heard.","Let's work through this together step-by-step.","Thank you for sharing something that may have been difficult to talk about."],mentalHealthQuestions:["What aspect of your work or workplace experience is currently affecting your mental or emotional well-being? (For example: workload, stress, burnout, workplace conflict, pressure, uncertainty, change, or isolation)","How would you describe what you are currently experiencing?","How is this affecting your day-to-day work experience? (For example: concentration, productivity, attendance, motivation, communication, or managing regular responsibilities)","Are there specific workplace situations, activities, or interactions that tend to make the situation worse?","Do you feel that your current workload, working hours, or work expectations are contributing to the concern?","Do you feel you have adequate support from your manager, team, or workplace to manage the situation?","Have you previously tried any steps or used any support to help manage what you are experiencing?","What type of support would be most helpful to you right now?","Would you like someone from the organisation to contact you to discuss available support options?","Do you feel safe at the moment?"],biasnessQuestions:["What specific action, decision, or behaviour made you feel that you were treated unfairly or excluded?","In what context did this occur? (For example: recruitment, promotion, performance review, compensation, work allocation, meetings, career opportunities, recognition, or day-to-day interactions)","Were you treated differently from one or more colleagues in a similar situation? If yes, please describe the difference in treatment.","Did you observe others with similar qualifications, experience, or circumstances receiving different treatment or opportunities?","Did the situation involve a decision made by someone with authority over you? If yes, what decision was made and how did it affect you?","Did you feel that your views, ideas, or contributions were overlooked, dismissed, or not given the same consideration as others?","Were you excluded from any meetings, discussions, networks, projects, or opportunities that you would reasonably have expected to participate in?","Did you notice any comments, language, or behaviour that you believe reflected stereotypes, assumptions, or preferences about you or another person?","Did you raise the issue or seek clarification from the person involved or another colleague? If yes, what response did you receive?","Has this situation affected your access to future opportunities, career development, recognition, or ability to participate fully at work?"],standardQuestions:["Could you tell me what happened in your own words?","When did this occur?","Is this an ongoing concern or a recent single incident?","Who was involved, or which team/department did this relate to?","How has this situation affected you personally or professionally?","Have you already spoken with anyone else or reported this before?","Would you prefer to submit this report completely anonymously?"],init(){this.renderWelcomeMessage()},renderWelcomeMessage(){const t=document.getElementById("chatMessages");t&&(t.innerHTML=`
    ...
    `,t.appendChild(e),this.scrollToBottom()},hideTypingIndicator(){const t=document.getElementById("aiTypingIndicator");t&&t.remove()},scrollToBottom(){const t=document.getElementById("chatMessages");t&&(t.scrollTop=t.scrollHeight)}};window.ChatEngine=v;const w={triggerPathway(){ChatEngine.addAiMessage(`
    ...
    `,i.classList.add("active"))},updateCaseOwner(t){const e=document.getElementById("caseRoutingSelect");if(!e)return;const i=e.value,o=INITIAL_SAMPLE_CASES.find(n=>n.id===t);o&&(o.owner=i,o.timeline.push({date:new Date().toLocaleString(),title:"Owner Reassigned",desc:`Reassigned to ${i} via AI-assisted routing.`}),alert(`Case ${t} reassigned to ${i}`),this.renderCasesTable(),this.openCaseDetails(t))},addNotePrompt(t){const e=prompt("Enter investigator note:");if(e){const i=INITIAL_SAMPLE_CASES.find(o=>o.id===t);i&&(i.timeline.push({date:new Date().toLocaleString(),title:"Investigator Note",desc:e}),this.openCaseDetails(t))}},resolveCase(t){const e=INITIAL_SAMPLE_CASES.find(i=>i.id===t);e&&(e.status="Resolved",e.timeline.push({date:new Date().toLocaleString(),title:"Case Resolved & Closed",desc:"Investigation completed and remedial actions recorded."}),alert(`Case ${t} marked as Resolved.`),WellbeingModule.closeModal(),this.renderCasesTable(),this.renderMetrics())}};window.DashboardModule=k;const C={processQuery(t){const e=document.getElementById("aiIntelResponseBox");e&&(e.style.display="block",e.innerHTML=`<em>🤖 AI Case Intelligence analyzing query: "${t}"...</em>`,setTimeout(()=>{let i="";const o=t.toLowerCase();o.includes("summary of cases")||o.includes("this month")?i=`
